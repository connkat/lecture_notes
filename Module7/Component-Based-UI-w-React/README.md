# Module7W16 - Component-Based UI with React
Hello, everyone! Today we got to take a dive into React components! We touched on quite a bit today (create-react-app, closures, state, props) so if you have any questions please don't hesitate to reach out!

- [lecture recording](https://vimeo.com/641755818/5fc1d7e63f)
- [notes](https://github.com/connkat/lecture_notes/tree/master/Module7/Component-Based-UI-w-React)
